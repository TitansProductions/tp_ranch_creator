		...
		while IS_PLACEMENT_BUSY do
			...
			if Builder.Entity then 
				...
				elseif data.animal then 
					SetEntityHeading(Builder.Entity, Builder.CurrentYaw)
				end

				if data.animal ~= nil then
					PlaceEntityOnGroundProperly(Builder.Entity, true)
				end
			...
			if IsControlJustReleased(0, 0xC7B5340A) then
				...
				if Builder.Entity then
					...
					if data.object then
						...
						local _entity = CreatePed(GetHashKey(Builder.ModelEntity), objectCoords.x, objectCoords.y, objectCoords.z, oppositeHeading, false, false, false, false )
						...
						local newCoords = { x = objectCoords.x, y = objectCoords.y, z = objectCoords.z, h = oppositeHeading}
