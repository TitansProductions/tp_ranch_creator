...
Locales = {
	...
	['MENU_BUTTON_HERDING']         = "Animal Herding & Wolf Attacks",
	...
	['NUI_MAIN_COORDS_BUTTON']         = "Set Coords",
	...
	['NUI_MILK_CONTAINER_ACCESS_BUTTON']  = "Set Coords",
	['NUI_MILK_CONTAINER_DELIVER_BUTTON'] = "Set Coords",
	...
	['NUI_PITCHFORK_BUTTON'] = "Set Coords",
	...
	['NUI_CAULDRON_BUTTON'] = "Set Coords",
	...
	['NUI_CAULDRON_TELEPORT_BUTTON'] = "Set Coords",
	...
	/* HERDING SECTION */
	['NUI_HERDING_DESCRIPTION']                    = "The herding section must be edited after finishing all the coordinates and spawnpoints related to all the desired animal types. If you don't edit herding section last, you will be having issues.",

	['MENU_HERDING_SECTION_BUTTON_SPAWN_POINTS']   = "Animal Spawn Points",
	['MENU_HERDING_SECTION_BUTTON_HERDING_POINTS'] = "Herding Points",
	['MENU_HERDING_SECTION_BUTTON_WOLF_ATTACKS']   = "Wolf Attacks",

	['NUI_HERDING_SPAWN_POINTS_DESCRIPTION']       = "Set the desired animal spawn points to allow the selected animals that will go out for herding, to be spawned properly in the desired positions for preventing any kind of bugs.",

	['NUI_HERDING_SPAWN_POINTS_NOT_ANIMALS_AVAILABLE'] = "There are no animals configured (cow, sheep & goats) to set any herding spawn points.",
	['NUI_HERDING_SPAWN_POINT_SET_SPAWNPOINT_BUTTON'] = "Set Spawnpoint",
	['NUI_HERDING_POINTS_CREATE_POSITION']            = "Create New Position",

	['NUI_HERDING_POINTS_DESCRIPTION']                = "Set the herding points that the spawned animals will follow until they reach the final herding destination.",

	['NUI_HERDING_POINTS_NOT_ANIMALS_AVAILABLE']   = "There are no animals (cow, sheep & goats) configured to set any herding points.",
	['NUI_HERDING_WOLF_ATTACKS_STATE_DESCRIPTION'] = "Set to disabled in case you are not interested having any wolf attacks when herding animals.",
	['NUI_HERDING_WOLF_ATTACKS_CHANCE_DESCRIPTION'] = "What should be the chance to have a wolf attack once herding starts?",
